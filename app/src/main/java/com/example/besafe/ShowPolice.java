...
import com.example.besafe.api.PoliceApiClient;
import com.example.besafe.api.PoliceApiInterface;
...
public class ShowPolice extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void retrofit(final String Latitude, final String Longitude) {
        ...
        Call<JsonObject> responseBodyCall = apiService.fetchCount(url);
