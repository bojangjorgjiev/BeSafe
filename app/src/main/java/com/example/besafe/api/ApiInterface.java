package com.example.besafe.api;

import com.example.besafe.Class.RootModel;
...
// Api Interface for calling the FCM endpoint with the appropriate headers.
// We need to send data, so we are calling POST request
